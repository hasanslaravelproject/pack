            ...
            <div class="nav-right col">
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="{{asset('assets/backend/images/dashboard/man.png')}}" alt="header-user">
    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-sidebar">
            <div class="main-header-left d-none d-lg-block">
                <div class="logo-wrapper"><a href="index.html"><img class="blur-up lazyloaded" src="{{asset('assets/backend/images/dashboard/multikart-logo.png')}}" alt=""></a></div>
            </div>
            <div class="sidebar custom-scrollbar">
                <div class="sidebar-user text-center">
                    <div><img class="img-60 rounded-circle lazyloaded blur-up" src="{{asset('assets/backend/images/dashboard/man.png')}}" alt="#">
                    </div>
                ...
                <div class="p-l-30 p-r-30">
                    <div class="chat-box">
                        <div class="people-list friend-list">
                            <ul class="list">
                                <li class="clearfix"><img class="rounded-circle user-image" src="{{asset('assets/backend/images/dashboard/user.png')}}" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="{{asset('assets/backend/images/dashboard/user1.jpg')}}" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="{{asset('assets/backend/images/dashboard/user2.jpg')}}" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="{{asset('assets/backend/images/dashboard/user3.jpg')}}" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="{{asset('assets/backend/images/dashboard/man.png')}}" alt="">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="{{asset('assets/backend/images/dashboard/user5.jpg')}}" alt="">
                                    <div class="status-circle away"></div>
                                    <div class="about">
                                ...
                                <li class="clearfix"><img class="rounded-circle user-image" src="{{asset('assets/backend/images/dashboard/designer.jpg')}}" alt="">
                                    <div class="status-circle online"></div>
                                    <div class="about">
